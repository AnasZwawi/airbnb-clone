  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="absolute cursor-pointer right-5 bottom-5 z-40 flex items-center gap-x-1 px-2 py-2 bg-white border border-1 rounded-md transition-all duration-150 hover:shadow-md hover:scale-105"
          onClick={() => {
            showGallery(true);
          }}
        >
