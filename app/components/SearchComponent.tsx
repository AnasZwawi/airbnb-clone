    ...
    <div>
      <Dialog>
        <DialogTrigger asChild>
          <div className="shadow-[0_2px_5px_0px_rgba(0,0,0,0.1)] transition-shadow duration-200 hover:shadow-md mx-5 mt-2 rounded-full py-[7px] px-3 border flex justify-between items-center cursor-pointer">
